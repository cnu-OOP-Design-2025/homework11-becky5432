...
void doTest3() {
    ...
    players.push_back(make_shared<UndeadAdapter>(make_shared<Zombie>(), CharacterType::Zombie));
    players.push_back(make_shared<UndeadAdapter>(make_shared<Skeleton>(), CharacterType::Skeleton));
    players.push_back(make_shared<UndeadAdapter>(make_shared<Lich>(), CharacterType::Lich));
